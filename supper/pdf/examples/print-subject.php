...
class MYPDF extends TCPDF {
    ...
    public function ColoredTable($header,$result) {
        ...
        foreach ($result as $odt) {
            ...
            $this->Cell($w[2], 7, $odt['class_name'], '1', 0, 'C', $fill);
...
$pdf->writeHTMLCell(0, 0, '', 30, '<h4>ອາຈານປະຈຳວີຊາ : '.$row['teach_name'].' </h4>', 0, 0, 0, true, 'L', true);
$pdf->writeHTMLCell(0, 0, 130, 30, '<h4>ສົກຮຽນ : '.$row['sch_name'].' </h4>', 0, 0, 0, true, 'L', true);
}
