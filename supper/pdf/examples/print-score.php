...
$result = $api->getPrintStudentScore();
...
$pdf->writeHTMLCell(0, 0, '', 20, '<h2><u>ຄະແນນປະຈຳເດືອນ ' . $row['month'] . '</u></h2>', 0, 0, 0, true, 'C', true);
  $pdf->writeHTMLCell(0, 0, '', 30, '<h4>ວີຊາ: ' . $row['sub_name'] . ' </h4>', 0, 0, 0, true, 'L', true);
  $pdf->writeHTMLCell(0, 0, 70, 30, '<h4>ອາຈານ: ' . $row['teach_name'] . ' </h4>', 0, 0, 0, true, 'L', true);
  $pdf->writeHTMLCell(0, 0, 120, 30, '<h4>ຫ້ອງ: ' . $row['class_name'] . ' </h4>', 0, 0, 0, true, 'L', true);
  $pdf->writeHTMLCell(0, 0, 150, 30, '<h4>ສົກຮຽນ : ' . $row['sch_name'] . ' </h4>', 0, 0, 0, true, 'L', true);
}
