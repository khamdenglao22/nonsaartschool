...
<h1 class="page-header">ລາຍງານ <small>ຂໍ້ມູນັກຮຽນ</small></h1>
<div class="row">
    ...
    <div class="col-xl-12">
        <div class="panel panel-inverse">
                ...
                <div class="card-header">
                    <div class="form-group row">
                        ...
                        <div class="col-md-2">
                            ...
                            <button class="btn btn-primary" id="btn_search_student" style="margin-top: 17px"> <i class="fa fa-search" aria-hidden="true"></i> ຄົ້ນຫາ</button>
                            <button class="btn btn-danger" id="btn_print_student" style="margin-top: 17px"> <i class="fa fa-print" aria-hidden="true"></i> ປິຼນ</button>
                        </div>
            ...
            <div class="panel-heading">
                <h4 class="panel-title">ລາຍງານຂໍ້ມູນັກຮຽນ</h4>
            ...
            <div class="panel-body">
               ...
               <div id="display_view_student_list" class="col-md-12"> </div>
