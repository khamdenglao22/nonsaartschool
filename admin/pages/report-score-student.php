...
<h1 class="page-header">ລາຍງານ<small>ຂໍ້ມູນຄະແນນບຸກຄົນ</small></h1>
<!-- end page-header -->
<!-- begin row -->
<div class="row">
    <!-- begin col-12 -->
                ...
                <div class="panel-body">
                    <div class="form-group row">
                        ...
                        <div class="col-md-2">
                            ...
                            <button class="btn btn-danger" id="btn_print_score_student" style="margin-top: 17px"> <i class="fa fa-print" aria-hidden="true"></i> ປິຼນ</button>
                        </div>
