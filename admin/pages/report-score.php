                ...
                <div class="panel-body">
                    <div class="form-group row">
                        ...
                        <div class="col-md-2">
                            ...
                            <button class="btn btn-primary" id="btn_search_score_class" style="margin-top: 17px"> <i class="fa fa-search" aria-hidden="true"></i> ຄົ້ນຫາ</button>
                            <button class="btn btn-danger" id="btn_print_score_class" style="margin-top: 17px"> <i class="fa fa-print" aria-hidden="true"></i> ປິຼນ</button>
                        </div>
