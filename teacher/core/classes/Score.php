...
class Score extends Database
{
    ...
    public function ViewScoreUpdate(){
    ...
    {
        $this->query("SELECT * FROM tb_teaching INNER JOIN tb_subject ON tb_teaching.sub_id = tb_subject.sub_id where class_id=:class_id AND teach_id=:teach_id AND sch_id=:sch_id");
