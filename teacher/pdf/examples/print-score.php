...
class MYPDF extends TCPDF
{
  ...
  public function ColoredTable($header, $result)
  {
    ...
    $this->Cell($w[2], 7, 'ອາຈານປະຈຳວີຊາ', 0, 0, 'L', 0, '');
  }
}
...
$pdf->writeHTMLCell(0, 0, 70, 35, '<h4>ອາຈານ: ' . $row['teach_name'] . ' </h4>', 0, 0, 0, true, 'L', true);
$pdf->writeHTMLCell(0, 0, 120, 35, '<h4>ຫ້ອງ: ' . $row['class_name'] . ' </h4>', 0, 0, 0, true, 'L', true);
